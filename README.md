...
- [Mundo 3 - Atributos e dimensões de arrays NumPy](#galaxia-3-mundo-3)
- [Mundo 4 - Indexação e filtragem de arrays NumPy](#galaxia-3-mundo-4)
- [Mundo 5 - Junção, separação e modificação de arrays NumPy](#galaxia-3-mundo-5)
...
- [Mundo 8 - Leitura e extração de dados de arquivos Excel](#galaxia-4-mundo-8)
- [Mundo 9 - Leitura e extração de dados de arquivos CSV](#galaxia-4-mundo-9)
- [Mundo 10 - Fontes de dados financeiros e econômicos](#galaxia-4-mundo-10)
- [Mundo 11 - Dados do mercado financeiro com Yahoo Finance](#galaxia-4-mundo-11)
- [Mundo 12 - Dados econômicos dos EUA com FRED](#galaxia-4-mundo-12)
...
#### <a name="galaxia-3-mundo-3"></a>Mundo 3 - Atributos e dimensões de arrays NumPy
...
#### <a name="galaxia-3-mundo-4"></a>Mundo 4 - Indexação e filtragem de arrays NumPy
...
#### <a name="galaxia-3-mundo-5"></a>Mundo 5 - Junção, separação e modificação de arrays NumPy
...
#### <a name="galaxia-4-mundo-8"></a>Mundo 8 - Leitura e extração de dados de arquivos Excel

Como ler arquivos Excel (.xlsx) com Pandas, configurar parâmetros de leitura como skiprows, index_col, na_values, decimal e usecols, além de exportar DataFrames para Excel.

#### <a name="galaxia-4-mundo-9"></a>Mundo 9 - Leitura e extração de dados de arquivos CSV

Como ler arquivos CSV com Pandas, configurar separadores, codificação (encoding), valores decimais e colunas específicas, especialmente para dados da CVM (Comissão de Valores Mobiliários).

#### <a name="galaxia-4-mundo-10"></a>Mundo 10 - Fontes de dados financeiros e econômicos

Apresentação das principais fontes de dados financeiros e econômicos disponíveis através do pandas-datareader, incluindo Yahoo Finance, FRED, World Bank, Fama-French Data e outras plataformas para coleta de dados de mercado.

#### <a name="galaxia-4-mundo-11"></a>Mundo 11 - Dados do mercado financeiro com Yahoo Finance

Como baixar dados de ações brasileiras e internacionais usando yfinance, configurar períodos de tempo, intervalos e trabalhar com múltiplas ações simultaneamente, incluindo exercícios práticos com o Ibovespa e ações específicas.

#### <a name="galaxia-4-mundo-12"></a>Mundo 12 - Dados econômicos dos EUA com FRED

Como acessar dados econômicos dos Estados Unidos através do Federal Reserve Economic Data (FRED), incluindo PIB, indicadores de educação, yields de títulos e inflação, com exemplos práticos de análise e visualização de dados.
